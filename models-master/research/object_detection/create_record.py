...
#   +Annotations
#   +JPEGImages
# python3 create_record.py --image_dir=/Custom/dataset-resized/trash/images
#                                      --annotations_dir=/Custom/dataset-resized/trash/annotations
#                                      --label_map_path=data/trash_label_map.pbtxt 
